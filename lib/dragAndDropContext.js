    ...
    class DragAndDropProvider extends React.Component {
        constructor() {
            ...
            this.updateDraggable = (id, data) => {
                this.setState(({ draggables }) => ({
                    draggables: draggables.map(draggable => {
                        if (draggable.id === id) {
                            return Object.assign(Object.assign({}, draggable), data);
                        }
                        return draggable;
                    })
                }));
            ...
            this.registerDroppable = (id, data) => {
                ...
                const droppable = Object.assign(Object.assign({ id }, data), { layout: { x: 0, y: 0, width: 0, height: 0 } });
            ...
            this.updateDroppable = (id, data) => {
                this.setState(({ droppables }) => ({
                    droppables: droppables.map(droppable => {
                        if (droppable.id === id) {
                            return Object.assign(Object.assign({}, droppable), data);
                        }
                        return droppable;
                    })
                }));
